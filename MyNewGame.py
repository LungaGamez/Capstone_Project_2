...
print("This is the height of the player prize: " +str(prize_height))
print("This is the width of the player prize: " +str(prize_width))
...
#You can test this out with the bool(...) function to see what boolean value types have. You will learn more about while loop structers later. 
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_RIGHT:
                keyRight = True
        # This event checks isef the key is up(i.e. not pressed by the user).
    ...
    # If the enemy2 is off the screen the user wins the game:
    ...
    # If the enemy3 is off the screen the user wins the game:
